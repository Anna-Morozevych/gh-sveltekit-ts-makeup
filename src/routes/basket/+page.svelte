<script lang="ts">
  ...
  function removeCartHandler(cartId: number) {
    removeFromCart(cartId);
    calculateSum(carts);
  }

  function calculateSum(items: Product[]) {
              ...
              {#each carts as cart}
                <div class="card">
                  ...
                  <div class="card__info">
                    <a href="{base}/categories/{cart.product_type}/{cart.id}">
                    ...
                    <div class="card__color-wrap">
                      ...
                      <div class="card__color-name">
                        {cart.selectedColor.colour_name}
                      </div>
                    </div>
                    {/if}
